...
@NgModule({
  ...
  declarations: [AppLoaderComponent, DateFormatPipe,
    ...
    AutocompletePipe, MaterialAutoCompleteComponent, TransposeTermsPipe, ScoreDetailsComponent
  ],
  exports: [AppLoaderComponent, DateFormatPipe, TranslateModule,
    ...
    AutocompletePipe, MaterialAutoCompleteComponent, MaterialModule, TransposeTermsPipe, ScoreDetailsComponent
  ],
